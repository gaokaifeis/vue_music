<template>
  <div class="player" v-show="playlist.length > 0">
        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-center" :class="disableCls">
              <i @click="togelPlaying" :class="playIcon"></i>
            </div>
            <div class="icon i-right" :class="disableCls">
              <i @click="next" class="icon-next"></i>
            </div>
            <div class="icon i-right">
              <i class="icon" :class="getFavariteIcon(currentSong)" @click="toggleFavorite(currentSong)"></i>
            </div>
          </div>
        </div>
      </div>
      ...
      <div @click="open" class="mini-player" v-show="!fullScreen">
        ...
        <div class="control">
          <progress-circle :radius="radius" :percent="percent">
            <i @click.stop="togelPlaying" class="icon-mini" :class="playIconMini"></i>
          </progress-circle>
        </div>
    ...
    <audio ref="audio" @ended="end" @timeupdate="updateTime" :src="currentSong.url" @play="ready" @error="error"></audio>
  </div>
</template>
